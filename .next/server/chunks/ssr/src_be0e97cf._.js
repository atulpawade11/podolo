...
"[project]/src/lib/api/services/products.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    getProducts: async (params)=>{
        try {
            if (!process.env.NEXT_PUBLIC_WP_API_URL) {
                return {
                    data: null,
                    error: 'WP_API_URL is not configured'
                };
            }
            ...
            const response = await fetch(url.toString(), {
                cache: process.env.CACHE_MODE || 'default'
            });
            if (!response.ok) {
                return {
                    data: null,
...
"[project]/src/app/(public)/shop/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$services$2f$products$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/api/services/products.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function ProductsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchProducts = async ()=>{
            setLoading(true);
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$services$2f$products$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["productApi"].getProducts();
            setProducts(data);
            setError(error);
            setLoading(false);
        };
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/src/app/(public)/shop/page.tsx",
            lineNumber: 25,
            columnNumber: 12
        }, this);
    }
...
//# sourceMappingURL=src_be0e97cf._.js.map